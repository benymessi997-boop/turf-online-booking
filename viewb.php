                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                               <a href="adminhome.php" class="nav-item nav-link ">Home</a>
								 <a href="add.php" class="nav-item nav-link ">Add Grounds</a>
								  <a href="viewg.php" class="nav-item nav-link ">View Grounds</a>
								    <a href="viewu.php" class="nav-item nav-link ">View Users</a>
									    <a href="viewb.php" class="nav-item nav-link active">View Bookings</a>
...
<table width="97%" height="297" align="center">
	...
	<tr>
		<td colspan="10" align="center"><h2>Booking  Details</h2></td>
  </tr>
	...
	<tr>
		<td colspan="10">&nbsp;</td>
		    ...
		    <tr>
          <td width="1%">&nbsp;</td>
          <td width="7%"><div align="center" class="style6"><strong>Format</strong> </div></td>
		  <td width="12%"><div align="center" class="style6"><strong>Ground Id</strong> </div></td>
		  <td width="10%"><div align="center" class="style6"><strong>Check In </strong> </div></td>
		   <td width="10%"><div align="center" class="style6"><strong>Slot</strong> </div></td>
		   <td width="15%"><div align="center" class="style6"><strong>Amount</strong> </div></td>
		   <td width="13%"><div align="center" class="style6"><strong>Customer Name</strong> </div></td>
		   ...
		   <td width="11%"><div align="center" class="style6"><strong>Address</strong> </div></td>
		    ...
		    <td width="11%"><div align="center" class="style6"><strong>Status</strong> </div></td>
        ...
        <tr>
		 <td width="1%">&nbsp;</td>
		  	    <td><div align="center"><?php echo $row['versus'];?></div></td>
			  <td><div align="center"><?php echo $row['rid'];?></div></td>
