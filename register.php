...
<body>
                                ...
                                <a href="index.php" class="nav-item nav-link ">Home</a>
								    <a href="admin.php" class="nav-item nav-link ">Admin</a>
									    <a href="user.php" class="nav-item nav-link ">User</a>
										    <a href="register.php" class="nav-item nav-link active">New User</a>
  ...
  <table width="38%" border="0" align="center" style="margin:0 auto;">
    ...
    <tr>
      ...
      <td width="61%"><input name="name" type="text" id="name"  required pattern="[A-Za-z ]{3,32}"/>
      </td>
    ...
    <tr>
      ...
      <td><input name="phone" type="text" id="phone"  required  pattern="[6789][0-9]{9}" /></td>
