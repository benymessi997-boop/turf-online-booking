                            ...
                            <div class="navbar-nav mr-auto py-0">
                                <a href="adminhome.php" class="nav-item nav-link ">Home</a>
								 <a href="add.php" class="nav-item nav-link">Add Grounds</a>
								  <a href="viewg.php" class="nav-item nav-link active">View Grounds</a>
...
<tr>
		...
		<td width="153"><div align="center" class="style6"><strong>Name</strong> </div></td>
			  ...
			  <td width="142" ><div align="center" class="style6"><strong></strong>Location</div></td>
			   <td width="142" ><div align="center" class="style6"><strong>Ground Image</strong> </div></td>
		...
		$qry=mysqli_query($conn,"select * from turf");
        ...
        <tr>
		    ...
		    <td><div align="center"><?php echo $row['type'];?></div></td>
			 ...
			 <th scope="col" style="text-align:center;><div align="center"><a href="delete.php?id=<?php echo $row['id'];?>">Delete</a></div></th>
