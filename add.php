...
$path=move_uploaded_file($file_loc,$folder.$file_name);
		$qry=mysqli_query($conn,"insert into turf  values('','$type','$name','$price','$place','$file_name')");
	if($qry)
	{
...
<body>
    <div class=" bg-white p-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                               <a href="adminhome.php" class="nav-item nav-link ">Home</a>
								 <a href="add.php" class="nav-item nav-link active ">Add Grounds</a>
								  <a href="viewg.php" class="nav-item nav-link ">View Grounds</a>
								    <a href="viewu.php" class="nav-item nav-link">View Users</a>
									    <a href="viewb.php" class="nav-item nav-link">View Bookings</a>
		...
		<form id="f1" name="f1" method="post" action="#" onSubmit="return vali()" enctype="multipart/form-data" style="padding:0px 0px 50px 0px;margin-bottom:60px;">
  <table width="34%" border="0" align="center">
    ...
    <tr>
      <td colspan="2"  align="center" ><div class="style5"><h3>Add Grounds</h></div></td>
    </tr>
