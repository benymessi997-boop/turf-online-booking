...
<body>
    <div class=" bg-white p-0">
                                ...
                                <a href="adminhome.php" class="nav-item nav-link ">Home</a>
								 <a href="add.php" class="nav-item nav-link">Add Grounds</a>
								  <a href="viewg.php" class="nav-item nav-link ">View Grounds</a>
								    <a href="viewu.php" class="nav-item nav-link active">View Users</a>
		...
		<table width="100%" align="center" style="margin:40px;">
	
		<tr>
		<td colspan="10" align="center"><h2>User Details</h2></td>
		</tr>
