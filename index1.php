                                ...
                                <a href="index.php" class="nav-item nav-link active">Home</a>
								    <a href="admin.php" class="nav-item nav-link ">Admin</a>
									    <a href="user.php" class="nav-item nav-link ">User</a>
										    <a href="register.oho" class="nav-item nav-link ">New User</a>
        ...
        <div class="container-fluid bg-dark text-light footer wow fadeIn" data-wow-delay="0.1s" style="margin-top:50px;">
            <div class="container pb-5">
                <div class="row g-5">
					...
					<div style="width:700px;margin:0 auto;margin-top:-60px;">
                    <div class="col-md-6 col-lg-4">
                        <h6 class="section-title text-start text-primary text-uppercase mb-4">Contact</h6>
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Velankanni </p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+91 9750221817</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>benymessi997@gmail.com</p>
